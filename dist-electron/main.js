...
const node_1$3 = __importDefault$9(node$1);
const type_1$4 = __importDefault$9(type);
class CommentNode extends node_1$3.default {
  clone() {
...
function findOne$1(test, nodes, recurse) {
  ...
  for (var i = 0; i < searchedNodes.length; i++) {
    ...
    if (recurse && (0, domhandler_1$2.hasChildren)(node2) && node2.children.length > 0) {
      var found = findOne$1(test, node2.children, true);
      if (found)
        return found;
    }
  }
...
function existsOne$1(test, nodes) {
  return (Array.isArray(nodes) ? nodes : [nodes]).some(function(node2) {
    return (0, domhandler_1$2.isTag)(node2) && test(node2) || (0, domhandler_1$2.hasChildren)(node2) && existsOne$1(test, node2.children);
  });
}
...
(function(exports$1) {
  ...
  __exportStar(stringify$1, exports$1);
...
(function(exports$1) {
  ...
  Object.defineProperty(exports$1, "compile", { enumerable: true, get: function() {
...
(function(exports$1) {
  ...
  Object.defineProperty(exports$1, "filters", { enumerable: true, get: function() {
    return filters_js_1.filters;
  } });
  var pseudos_js_1 = pseudos;
  Object.defineProperty(exports$1, "pseudos", { enumerable: true, get: function() {
    return pseudos_js_1.pseudos;
  } });
  var aliases_js_1 = aliases;
  Object.defineProperty(exports$1, "aliases", { enumerable: true, get: function() {
...
const type_1$3 = __importDefault$3(type);
...
const he_1$1 = heExports;
const node_1$2 = __importDefault$2(node$1);
const type_1$2 = __importDefault$2(type);
class TextNode extends node_1$2.default {
  clone() {
...
const css_select_1 = lib$6;
const he_1 = __importDefault$1(heExports);
const back_1 = __importDefault$1(back);
const matcher_1 = __importDefault$1(matcher);
const void_tag_1 = __importDefault$1(voidTag);
const comment_1$1 = __importDefault$1(comment);
const node_1$1 = __importDefault$1(node$1);
const text_1$1 = __importDefault$1(text);
const type_1$1 = __importDefault$1(type);
function decode(val) {
...
class HTMLElement extends node_1$1.default {
  /**
   ...
   */
  constructor(tagName, keyAttrs, rawAttrs = "", parentNode = null, range, voidTag2 = new void_tag_1.default(), _parseOptions = {}) {
    super(parentNode, range);
    this.rawAttrs = rawAttrs;
    this.voidTag = voidTag2;
  ...
  set textContent(val) {
    const content = [new text_1$1.default(val, this)];
  ...
  replaceWith(...nodes) {
    ...
    const content = nodes.map((node2) => {
      if (node2 instanceof node_1$1.default) {
        return [node2];
      } else if (typeof node2 == "string") {
        const r = parse$2(node2, this._parseOptions);
        return r.childNodes.length ? r.childNodes : [new text_1$1.default(node2, this)];
      }
      return [];
    }).flat();
  ...
  insertAdjacentHTML(where, html2) {
    ...
    const p = parse$2(html2, this._parseOptions);
    if (where === "afterend") {
...
function base_parse(data, options = {}) {
  var _a, _b;
  const voidTag2 = new void_tag_1.default((_a = options === null || options === void 0 ? void 0 : options.voidTag) === null || _a === void 0 ? void 0 : _a.closingSlash, (_b = options === null || options === void 0 ? void 0 : options.voidTag) === null || _b === void 0 ? void 0 : _b.tags);
  ...
  const root = new HTMLElement(null, {}, "", null, [0, data.length], voidTag2, options);
  ...
  while (match = kMarkupPattern.exec(data)) {
    ...
    if (!leadingSlash) {
      ...
      currentParent = currentParent.appendChild(
        ...
        new HTMLElement(tagName, attrs, attributes2.slice(1), null, createRange(tagStartPos2, tagEndPos2), voidTag2, options)
      );
      ...
      if (is_block_text_element(tagName)) {
        ...
        if (element_should_be_ignore(tagName)) {
          ...
          if (text2.length > 0 && /\S/.test(text2)) {
            currentParent.appendChild(new text_1$1.default(text2, currentParent, createRange(tagEndPos2, textEndPos)));
          }
        }
        if (closeIndex === -1) {
...
function resolveInsertable(insertable) {
  return insertable.map((val) => {
    if (typeof val === "string") {
      return new text_1$1.default(val);
    }
    val.remove();
    return val;
  });
...
function valid(data, options = {}) {
  const stack = (0, html_1$1.base_parse)(data, options);
...
const comment_1 = __importDefault(comment);
dist.CommentNode = comment_1.default;
const html_1 = __importDefault(html);
...
const type_1 = __importDefault(type);
dist.NodeType = type_1.default;
const parse_1 = __importDefault(parse$1);
const valid_1 = __importDefault(valid$1);
...
app.whenReady().then(() => {
  const { net: net2 } = require$1("electron");
